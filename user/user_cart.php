...
<body>
  ...
  <div class="container">
    <div class="p-3 shadow-sm d-flex justify-content-around align-items-center rounded" style="width: 50%">
...
<div class="box-container">
  ...
  <div class="box">
    ...
    <img src="/PortalBuku-4One/resources/img/keranjangsu.png <?php echo $fetch_cart['gambar']; ?>" alt="">
...
<!-- <div style="margin-top: 2rem; text-align:left;">
  <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>"
    onclick="return confirm('delete all from cart?');"><input type="submit" value="Delete All">
</a>
</div> -->
