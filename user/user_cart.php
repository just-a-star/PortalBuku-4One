        ...
        if (mysqli_num_rows($select_cart) > 0) {
          while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
            ...
            <div class="table">
              <div class="row">
                <div class="col-2">
                  <img src="../resources/gambar_upload/<?php echo $fetch_cart['gambar']; ?>" alt="" width="70%">
                </div>
                <div class="col-5">
                  <div class="name">
                    <h3><?php echo $fetch_cart['nama']; ?></h3>
                  </div>
                  <h5>Harga:<div class="price">$<?php echo $fetch_cart['harga_sewa']; ?>/-</div></h5>
                </div>
                <div class="col-1" style="text-align: center; ;">
                <a href="user_cart.php?delete=<?php echo $fetch_cart['id']; ?>" onclick="return confirm('delete this from cart?');"> 
                  <img src="/PortalBuku-4One/resources/gambar/trash.svg" alt="Keranjang belanjaan" width="50%" height="50%"/></a>
