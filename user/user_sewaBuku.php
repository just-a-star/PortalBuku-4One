                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleTopbar">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/PortalBuku-4One/about us after login.php">Tentang Portal
                                    Buku</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="container">
                <div class="container-fluid">
                    <span class="navbar-brand mb-0 h1"
                        onclick="document.location='/PortalBuku-4One/homepage.php'">Portal
                        Buku.id</span>
                </div>
            </div>
        </nav>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav me-auto">
                    ...
                    <a href="/PortalBuku-4One/user/user_cart.php" class="nav-item nav-link me-3">
                        <img src="/PortalBuku-4One\resources\img\keranjangsu.png" alt="Keranjang belanjaan"
                            style="width: 30%" />
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/PortalBuku-4One\resources\img/novel.jpg" class="img-fluid" alt="slide1">
                            <div class="carousel-caption">
                                <h6>Buku baru telah <br> tersedia!</h6>
                                <p>Hai hai teman-teman! <br> suka baca buku? <br> atau sedang mencari referensi materi?
                                </p>
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <form action="" method="post" class="box">
                ...
                <div class="kartu card">
                    <img class="img-thumbnail img-responsive img-fluid card-img-top"
                        src="../resources/gambar_upload/<?php echo $fetch_products['gambar']; ?>" alt="">
                    <div class="nama">
                        <?php echo $fetch_products['nama']; ?>
                    </div>
                    <div class="card-body">
                        <div class="harga_buku">$<?php echo $fetch_products['harga_sewa']; ?>/- Per hari</div>
                        ...
                        <input class="btn btn-primary" name="masukkan_keranjang" id="masukkan_keranjang" type="submit"
                            value="Masukkan ke Keranjang">
                    </div>
                </div>
